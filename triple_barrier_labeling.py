...
try:
    ...
    _path = os.path.join(os.path.dirname(__file__), "src", "triple_barrier_labeling.py")
    if os.path.isfile(_path):
        spec = importlib.util.spec_from_file_location("src.triple_barrier_labeling", _path)
