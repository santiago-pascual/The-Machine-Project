...
try:
    ...
    _path = os.path.join(os.path.dirname(__file__), "src", "growth_rebalance_cadence_parity_backtest.py")
    if os.path.isfile(_path):
        spec = importlib.util.spec_from_file_location("src.growth_rebalance_cadence_parity_backtest", _path)
