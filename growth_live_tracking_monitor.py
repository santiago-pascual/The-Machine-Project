...
try:
    ...
    _path = os.path.join(os.path.dirname(__file__), "src", "growth_live_tracking_monitor.py")
    if os.path.isfile(_path):
        spec = importlib.util.spec_from_file_location("src.growth_live_tracking_monitor", _path)
