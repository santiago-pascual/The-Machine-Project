...
try:
    ...
    _path = os.path.join(os.path.dirname(__file__), "src", "regime_conditional_meta_filter.py")
    if os.path.isfile(_path):
        spec = importlib.util.spec_from_file_location("src.regime_conditional_meta_filter", _path)
