...
try:
    ...
    _path = os.path.join(os.path.dirname(__file__), "src", "feature_selection_engine.py")
    if os.path.isfile(_path):
        spec = importlib.util.spec_from_file_location("src.feature_selection_engine", _path)
