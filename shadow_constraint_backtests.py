...
try:
    ...
    _path = os.path.join(os.path.dirname(__file__), "src", "shadow_constraint_backtests.py")
    if os.path.isfile(_path):
        spec = importlib.util.spec_from_file_location("src.shadow_constraint_backtests", _path)
