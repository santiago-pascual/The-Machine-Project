...
try:
    ...
    _path = os.path.join(os.path.dirname(__file__), "src", "full_quant_robustness_walk_forward.py")
    if os.path.isfile(_path):
        spec = importlib.util.spec_from_file_location("src.full_quant_robustness_walk_forward", _path)
