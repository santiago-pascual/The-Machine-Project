...
try:
    ...
    _path = os.path.join(os.path.dirname(__file__), "src", "final_champion_backtest.py")
    if os.path.isfile(_path):
        spec = importlib.util.spec_from_file_location("src.final_champion_backtest", _path)
