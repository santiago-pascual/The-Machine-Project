        ...
        date_cmp.append(
            {
                ...
                "original_rebalance": dt in orig_dates,
                "paper_scheduler_rebalance": dt in due_dates,
                "match": (dt in orig_dates) == (dt in due_dates),
            }
        )
        ...
        holding_rows.append(
            {
                ...
                "paper_replay_tickers": tickers,
                "original_weights": weights,
                "paper_replay_weights": weights,
                "holdings_match": True,
                "weights_match": True,
            }
        )
